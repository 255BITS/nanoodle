...
zero-history account's first act.
...
- Thumbnail/first gallery slot: `shareassets/nanoodle-demo-square-1080.mp4`
  (PH favors a moving first asset).
...
- If Cookoff winners are curated by launch day: one gallery slide of community
  noodles, credited — "built by users last week" is the strongest slide.
...
Last week the community ran a little build contest and the entries blew me away —
happy to share what strangers made with it in the comments. Ask me anything,
especially about the single-file/no-server architecture. 🍜
...
- **"How is it different from [AI app builder X]?"** — Most builders host your app
  ...
  pitch.
- **"Roadmap?"** — Answer honestly from the current backlog (gallery of community
  noodles, more nodes). Don't promise dates.
...
- Quote a good HN exchange from Jul 14 if one happened.
- Log in shares.md.
